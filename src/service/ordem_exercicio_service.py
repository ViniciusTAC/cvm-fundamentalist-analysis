...
# from models.ordem_exercicio import Ordem_exercicio


# def process_csv_files(base_path):
#     descricao_unica_set = set()
#     ordem_exercicio_list = []
...
#                         )
#                         ordem_exercicio_list.append(ordem_exercicio)

#     return ordem_exercicio_list
...
def process_csv_files(base_path, conexao, campo="ORDEM_EXERC"):
    ...
    # Transformar os valores únicos em objetos Ordem_exercicio
    return [Ordem_exercicio(_descricao=valor) for valor in valores_unicos]
