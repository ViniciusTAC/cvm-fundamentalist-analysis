...
def process_csv_files(base_path, conexao, campo="MOEDA"):
    ...
    # Transformar os valores únicos em objetos Moeda
    return [Moeda(_descricao=valor) for valor in valores_unicos]
