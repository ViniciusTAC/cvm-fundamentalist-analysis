...
# #                     erros.append(str(e))
# #         conn.commit()
# #         print(f"Categoria Documento: {sucesso} inseridos, {falha} com erro.")
# #         if erros:
# #             with open("logs/erros_categoria_documento.log", "w", encoding="utf-8") as f:
# #                 f.write("\n".join(erros))
# #     except Exception as e:
# #         conn.rollback()
# #         print(f"Erro fatal ao processar Categoria Documento: {e}")
# #     finally:
# #         repo.desconectar()
...
# #                     erros.append(str(e))
# #         conn.commit()
# #         print(f"Tipo Parecer: {sucesso} inseridos, {falha} com erro.")
# #         if erros:
# #             with open("logs/erros_tipo_parecer.log", "w", encoding="utf-8") as f:
# #                 f.write("\n".join(erros))
# #     except Exception as e:
# #         conn.rollback()
# #         print(f"Erro fatal ao processar Tipo Parecer: {e}")
# #     finally:
# #         repo.desconectar()
...
# #                     erros.append(str(e))
# #         conn.commit()
# #         print(f"Escala Monetária: {sucesso} inseridos, {falha} com erro.")
# #         if erros:
# #             with open("logs/erros_escala_monetaria.log", "w", encoding="utf-8") as f:
# #                 f.write("\n".join(erros))
# #     except Exception as e:
# #         conn.rollback()
# #         print(f"Erro fatal ao processar Escala Monetária: {e}")
# #     finally:
# #         repo.desconectar()
...
# #                     erros.append(str(e))
# #         conn.commit()
# #         print(f"Ordem Exercício: {sucesso} inseridos, {falha} com erro.")
# #         if erros:
# #             with open("logs/erros_ordem_exercicio.log", "w", encoding="utf-8") as f:
# #                 f.write("\n".join(erros))
# #     except Exception as e:
# #         conn.rollback()
# #         print(f"Erro fatal ao processar Ordem Exercício: {e}")
# #     finally:
# #         repo.desconectar()
...
# #                     erros.append(str(e))
# #         conn.commit()
# #         print(f"Moeda: {sucesso} inseridos, {falha} com erro.")
# #         if erros:
# #             with open("logs/erros_moeda.log", "w", encoding="utf-8") as f:
# #                 f.write("\n".join(erros))
# #     except Exception as e:
# #         conn.rollback()
# #         print(f"Erro fatal ao processar Moeda: {e}")
# #     finally:
# #         repo.desconectar()
...
#                 entrada["base_path"], entrada["regex_arquivo"], entrada["campo"]
#             )
#             for dado in dados:
#                 try:
#                     repo.inserir_ou_ignorar_categoria_documento(dado)
...
def executar_escala_monetaria():
    ...
    try:
        ...
        if erros:
            with open("logs/erros_escala_monetaria.log", "w", encoding="utf-8") as f:
                f.write("\n".join(erros))
        return f"Escala Monetária: {sucesso} inseridos, {falha} com erro."
    except Exception as e:
        conn.rollback()
        return f"Erro fatal ao processar Escala Monetária: {e}"
    finally:
        repo.desconectar()
...
def executar_ordem_exercicio():
    ...
    try:
        ...
        if erros:
            with open("logs/erros_ordem_exercicio.log", "w", encoding="utf-8") as f:
                f.write("\n".join(erros))
        return f"Ordem Exercício: {sucesso} inseridos, {falha} com erro."
    except Exception as e:
        conn.rollback()
        return f"Erro fatal ao processar Ordem Exercício: {e}"
    finally:
        repo.desconectar()
...
def executar_moeda():
    ...
    try:
        ...
        if erros:
            with open("logs/erros_moeda.log", "w", encoding="utf-8") as f:
                f.write("\n".join(erros))
        return f"Moeda: {sucesso} inseridos, {falha} com erro."
    except Exception as e:
        conn.rollback()
        return f"Erro fatal ao processar Moeda: {e}"
    finally:
        repo.desconectar()
