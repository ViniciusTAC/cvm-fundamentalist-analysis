...
class ConexaoBanco:
    ...
    def inserir_ou_atualizar_demonstrativo(self, demonstrativo):
        try:
            ...
            values = (
                tratar_valor(demonstrativo._codigo_conta),
                tratar_valor(demonstrativo._cnpj_companhia),
                tratar_valor(demonstrativo._codigo_cvm),
                tratar_valor(demonstrativo._escala_monetaria),
                tratar_valor(demonstrativo._grupo_dfp),
                tratar_valor(demonstrativo._moeda, tipo="int"),
                tratar_valor(demonstrativo._ordem_exercicio),
                tratar_valor(demonstrativo._conta_fixa),
                tratar_valor(demonstrativo._versao, tipo="int"),
                tratar_valor(demonstrativo._data_inicio_exercicio, tipo="date"),
                tratar_valor(demonstrativo._data_fim_exercicio, tipo="date"),
                tratar_valor(demonstrativo._data_referencia_doc, tipo="date"),
                tratar_valor(demonstrativo._valor_conta, tipo="float"),
                tratar_valor(demonstrativo._data_doc, tipo="date"),
            ...
            print(f"✔ Demonstrativo inserido para CNPJ {demonstrativo._cnpj_companhia}, conta {demonstrativo._codigo_conta}.")
        except sqlite3.Error as e:
            ...
            print(f"❌ Erro ao inserir demonstrativo para CNPJ {demonstrativo._cnpj_companhia}, erro: {e}")
