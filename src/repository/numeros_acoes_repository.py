    ...
    def inserir_numeros_acoes(self, numeros_acoes):
        try:
            ...
            values = (
                    ...
                    tratar_valor(numeros_acoes._denominacao_companhia),
                    ...
                    tratar_valor(numeros_acoes._data_referencia_doc,tipo="date"),
                    tratar_valor(numeros_acoes._data_doc,tipo="date"),
                    tratar_valor(numeros_acoes._mes_doc,tipo="int"),
                    tratar_valor(numeros_acoes._ano_doc,tipo="int"),
            )
            # print("\n\n")
            ...
            # escrever_linha_em_branco()
            self.log_sucesso.info(f"Numero de Ações {numeros_acoes._denominacao_companhia}, do CNPJ: {numeros_acoes._cnpj_companhia} e do ano {numeros_acoes._ano_doc} e da Fonte de dados: {numeros_acoes._fonte_dados} inserida com sucesso.")
            print(
            ...
            self.log_erro.error(
                f"Erro ao inserir Numero de Ações {numeros_acoes._denominacao_companhia}, do CNPJ: {numeros_acoes._cnpj_companhia} e do ano {numeros_acoes._ano_doc} e da Fonte de dados: {numeros_acoes._fonte_dados}, erro: {e}."
            )
            escrever_linha_em_branco(self.log_erro)
            print(
                f"Erro ao inserir Numero de Ações {numeros_acoes._denominacao_companhia}, do CNPJ: {numeros_acoes._cnpj_companhia} e do ano {numeros_acoes._ano_doc} e da Fonte de dados: {numeros_acoes._fonte_dados}, erro: {e}."
